...
type PreviewTripRequest struct {
	...
	EndtLocation  *Coordinate            `protobuf:"bytes,3,opt,name=endtLocation,proto3" json:"endtLocation,omitempty"`
...
func (x *PreviewTripRequest) GetEndtLocation() *Coordinate {
	if x != nil {
		return x.EndtLocation
	}
	return nil
}
...
const file_trip_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"trip.proto\x12\x04trip\"\x9a\x01\n" +
	"\x12PreviewTripRequest\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x126\n" +
	"\rstartLocation\x18\x02 \x01(\v2\x10.trip.CoordinateR\rstartLocation\x124\n" +
	"\fendtLocation\x18\x03 \x01(\v2\x10.trip.CoordinateR\fendtLocation\"~\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	2, // 1: trip.PreviewTripRequest.endtLocation:type_name -> trip.Coordinate
